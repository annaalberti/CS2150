...
private:
  ...
  void insert(const string& x, AVLNode*& curNode) ; //this is my helper insert method
  bool find( const string& x, AVLNode* const curNode) const; //helper find method
  string pathTo(const string& x,  AVLNode * const curNode) const; //helper pathTo method
  int numNodes( AVLNode* const curNode) const; //helper numNode method
  int getBalanceFactor(const AVLNode* n)const ; //will return the balance factor

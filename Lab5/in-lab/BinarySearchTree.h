...
public:
  ...
  int numNodes() const; //i changed this to void bc of my helper method
...
private:
  ...
  void insert(const string& x, BinaryNode*& curNode) ; //this is my helper insert method
  bool find( const string& x, BinaryNode* const curNode) const; //helper find method
  string pathTo(const string& x,  BinaryNode * const curNode) const; //helper pathTo method
  int numNodes( BinaryNode* const curNode) const; //helper numNode method
};
